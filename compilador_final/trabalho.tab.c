...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_ABRE_CHAVES = 7,                /* ABRE_CHAVES  */
  YYSYMBOL_RETORNO = 8,                    /* RETORNO  */
  YYSYMBOL_PONTO_E_VIRGULA = 9,            /* PONTO_E_VIRGULA  */
  YYSYMBOL_FECHA_CHAVES = 10,              /* FECHA_CHAVES  */
  YYSYMBOL_DESCONHECIDO = 11,              /* DESCONHECIDO  */
  YYSYMBOL_SOMA = 12,                      /* SOMA  */
  YYSYMBOL_SUBTRACAO = 13,                 /* SUBTRACAO  */
  YYSYMBOL_MULTIPLICACAO = 14,             /* MULTIPLICACAO  */
  YYSYMBOL_IGUAL = 15,                     /* IGUAL  */
  YYSYMBOL_OPERADOR_RELACIONAL = 16,       /* OPERADOR_RELACIONAL  */
  ...
  YYSYMBOL_24_3 = 24,                      /* $@3  */
  YYSYMBOL_25_4 = 25,                      /* $@4  */
  YYSYMBOL_declaracao_variavel = 26,       /* declaracao_variavel  */
  YYSYMBOL_resultado = 27,                 /* resultado  */
...
{
       0,   292,   292,   292,   294,   294,   295,   295,   296,   296,
     297,   299,   301,   302,   307,   308,   309,   310,   312,   313,
     314,   315,   316,   317
};
#endif
...
{
  "\"end of file\"", "error", "\"invalid token\"", "INTEIRO", "PRINCIPAL",
  "ABRE_PARENTESES", "FECHA_PARENTESES", "ABRE_CHAVES", "RETORNO",
  "PONTO_E_VIRGULA", "FECHA_CHAVES", "DESCONHECIDO", "SOMA", "SUBTRACAO",
  "MULTIPLICACAO", "IGUAL", "OPERADOR_RELACIONAL", "IDENTIFICADOR",
  "NUMERO", "$accept", "programa", "$@1", "bloco", "$@2", "$@3", "$@4",
  "declaracao_variavel", "resultado", "expressao", YY_NULLPTR
};
...
{
      -2,     0,     6,     4,   -29,    -3,    11,   -29,    -1,    -6,
       3,    12,     2,   -29,    17,     3,   -29,   -29,    37,     5,
     -29,    -1,   -29,    19,   -29,     3,     3,     3,     5,   -29,
     -29,    43,   -29,    -1,   -29,    -1,    14,    14,   -29,    31,
     -29,     5,     5,     5,   -29,   -29,   -29,    15,    15,   -29
};
...
static const yytype_int8 yydefact[] =
{
       ...
       0,     0,     0,     8,     0,     0,    23,    22,     0,     0,
       3,    10,     6,     0,     4,     0,     0,     0,     0,    13,
      12,     0,     9,    10,    21,    10,    18,    19,    20,     0,
      11,     0,     0,     0,     7,     5,    17,    14,    15,    16
};

/* YYPGOTO[NTERM-NUM].  */
static const yytype_int8 yypgoto[] =
{
     -29,   -29,   -29,   -16,   -29,   -29,   -29,   -29,   -28,     9
};

/* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
       0,     2,     8,    12,    35,    33,    21,    13,    31,    18
};
...
{
      39,     1,     9,     6,     3,    32,     4,    10,    15,     5,
      28,    14,    20,    47,    48,    49,    11,    44,     7,    45,
      16,    17,    29,    30,    23,    34,    22,    19,    27,    43,
       0,    25,    26,    27,    36,    37,    38,    46,     0,     0,
       0,     0,     0,    41,    42,    43,    24,     0,     0,    25,
      26,    27,    40,     0,     0,    41,    42,    43
};

static const yytype_int8 yycheck[] =
{
      28,     3,     3,     6,     4,    21,     0,     8,     5,     5,
       5,    17,    10,    41,    42,    43,    17,    33,     7,    35,
      17,    18,    17,    18,    15,     6,     9,    15,    14,    14,
      -1,    12,    13,    14,    25,    26,    27,     6,    -1,    -1,
      -1,    -1,    -1,    12,    13,    14,     9,    -1,    -1,    12,
      13,    14,     9,    -1,    -1,    12,    13,    14
};
...
{
       0,     3,    20,     4,     0,     5,     6,     7,    21,     3,
       8,    17,    22,    26,    17,     5,    17,    18,    28,    15,
      10,    25,     9,    28,     9,    12,    13,    14,     5,    17,
      18,    27,    22,    24,     6,    23,    28,    28,    28,    27,
       9,    12,    13,    14,    22,    22,     6,    27,    27,    27
};

/* YYR1[RULE-NUM] -- Symbol kind of the left-hand side of rule RULE-NUM.  */
static const yytype_int8 yyr1[] =
{
       0,    19,    21,    20,    23,    22,    24,    22,    25,    22,
      22,    26,    27,    27,    27,    27,    27,    27,    28,    28,
      28,    28,    28,    28
};
...
#line 292 "trabalho.y"
                                                                                 {montar_inicio();}
#line 1366 "trabalho.tab.c"
    break;

  case 3: /* programa: INTEIRO PRINCIPAL ABRE_PARENTESES FECHA_PARENTESES ABRE_CHAVES $@1 bloco FECHA_CHAVES  */
#line 292 "trabalho.y"
                                                                                                                       {montar_final();}
#line 1372 "trabalho.tab.c"
    break;

  case 4: /* $@2: %empty  */
#line 294 "trabalho.y"
                                                                        {imprimir_resultado();}
#line 1378 "trabalho.tab.c"
    break;

  case 6: /* $@3: %empty  */
#line 295 "trabalho.y"
                                                                                {criar_variavel((yyvsp[-1].string));}
#line 1384 "trabalho.tab.c"
    break;

  case 8: /* $@4: %empty  */
#line 296 "trabalho.y"
                                                                                                        {valor = 0;}
#line 1390 "trabalho.tab.c"
    break;

  case 11: /* declaracao_variavel: IDENTIFICADOR IGUAL resultado PONTO_E_VIRGULA  */
#line 299 "trabalho.y"
                                                                                        {definir_valor_variavel((yyvsp[-3].string));}
#line 1396 "trabalho.tab.c"
    break;

  case 12: /* resultado: NUMERO  */
#line 301 "trabalho.y"
                                                                                        {empilhar_pilha(&p_pilha, (yyvsp[0].inteiro));}
#line 1402 "trabalho.tab.c"
    break;

  case 13: /* resultado: IDENTIFICADOR  */
#line 302 "trabalho.y"
                                                                                                        {for(i=0; i < TOTAL_VARIAVEIS; i++) {
														if (strcmp((yyvsp[0].string), etiquetas_variaveis[i]) == 0){
															valor = resultados_variaveis[i]; empilhar_pilha(&p_pilha, valor); valor = 0;
														}
													}}
#line 1412 "trabalho.tab.c"
    break;

  case 14: /* resultado: resultado SOMA resultado  */
#line 307 "trabalho.y"
                                                                                                        {valor+=*topo_pilha(&p_pilha); desfazer(&p_pilha); valor+=*topo_pilha(&p_pilha); desfazer(&p_pilha); empilhar_pilha(&p_pilha, valor); valor = 0;}
#line 1418 "trabalho.tab.c"
    break;

  case 15: /* resultado: resultado SUBTRACAO resultado  */
#line 308 "trabalho.y"
                                                                                                        {valor+=(0 - *topo_pilha(&p_pilha)); desfazer(&p_pilha); valor+=(*topo_pilha(&p_pilha)); desfazer(&p_pilha); empilhar_pilha(&p_pilha, valor); valor = 0;}
#line 1424 "trabalho.tab.c"
    break;

  case 16: /* resultado: resultado MULTIPLICACAO resultado  */
#line 309 "trabalho.y"
                                                                                                                {valor=*topo_pilha(&p_pilha); desfazer(&p_pilha); valor*=*topo_pilha(&p_pilha); desfazer(&p_pilha); empilhar_pilha(&p_pilha, valor); valor = 0;}
#line 1430 "trabalho.tab.c"
    break;

  case 18: /* expressao: expressao SOMA expressao  */
#line 312 "trabalho.y"
                                                                                            {soma();}
#line 1436 "trabalho.tab.c"
    break;

  case 19: /* expressao: expressao SUBTRACAO expressao  */
#line 313 "trabalho.y"
                                                                                                    {subtracao();}
#line 1442 "trabalho.tab.c"
    break;

  case 20: /* expressao: expressao MULTIPLICACAO expressao  */
#line 314 "trabalho.y"
                                                                                                            {multiplicacao();}
#line 1448 "trabalho.tab.c"
    break;

  case 22: /* expressao: NUMERO  */
#line 316 "trabalho.y"
                                                                                                    {ad_numero((yyvsp[0].inteiro));  }
#line 1454 "trabalho.tab.c"
    break;

  case 23: /* expressao: IDENTIFICADOR  */
#line 317 "trabalho.y"
                                                                                                    {inserir_variavel((yyvsp[0].string));}
#line 1460 "trabalho.tab.c"
    break;


#line 1464 "trabalho.tab.c"
